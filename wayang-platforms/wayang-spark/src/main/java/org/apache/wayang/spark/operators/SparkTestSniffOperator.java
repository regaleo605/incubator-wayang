...
public class SparkTestSniffOperator<InputType,OutputType>
        extends TestSniffOperator<InputType,OutputType>
        implements SparkExecutionOperator {

    public SparkTestSniffOperator(DataSetType inputType, DataSetType outputType,
                              FlatMapDescriptor<InputType, OutputType> functionDescriptor) {
        super(functionDescriptor, inputType, outputType);
    }

    public SparkTestSniffOperator(TestSniffOperator<InputType, OutputType> that) {
        super(that);
    }

...
public class JavaSniffOperator<InputType,OutputType>
            extends SniffOperator<InputType,OutputType>
            implements JavaExecutionOperator{

    public JavaSniffOperator(DataSetType<InputType> inputType, DataSetType<OutputType> outputType,
                               FlatMapDescriptor<InputType, OutputType> functionDescriptor) {
        super(functionDescriptor, inputType, outputType);
    }

    public JavaSniffOperator(SniffOperator<InputType, OutputType> that) {
        super(that);
    }

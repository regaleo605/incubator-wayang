...
public class ConsoleUI<K,T> {
    ...
    private KafkaProducer<String,String> signalSender;
    ...
    public void initialize(){
        ...
        property.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, StringSerializer.class.getName());
        ...
        prop2.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class.getName());
    ...
    public void sendSignal(){
        ...
        ProducerRecord<String,String> producerRecord = new ProducerRecord("signal",s);
    ...
    public void sendCustomSignal(){
        ...
        ProducerRecord<String,String> producerRecord = new ProducerRecord<>(topic,c);
        signalSender.send(producerRecord);
    }
    ...
    public void getNextTuple(){
        ...
        while (true) {
            ...
            consumerRecords.forEach(record -> {
                HackitTuple<K,T> tuple = new HackitTuple<>(record.value());

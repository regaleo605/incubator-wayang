...
public class TestSniffOperator<InputType,OutputType> extends UnaryToUnaryOperator<InputType,OutputType> {
    protected final FlatMapDescriptor<InputType, OutputType> functionDescriptor;

    public TestSniffOperator(FunctionDescriptor.SerializableFunction<InputType, Iterable<OutputType>> function,
    ...
    public TestSniffOperator(FlatMapDescriptor<InputType, OutputType> functionDescriptor) {
    ...
    public TestSniffOperator(TestSniffOperator<InputType, OutputType> that) {
        super(that);
    ...
    private class CardinalityEstimator implements org.apache.wayang.core.optimizer.cardinality.CardinalityEstimator {
        ...
        private CardinalityEstimator(Configuration configuration) {
            this.selectivity = configuration
                    ...
                    .provideFor(TestSniffOperator.this.functionDescriptor);
        }

        @Override
        public CardinalityEstimate estimate(OptimizationContext optimizationContext, CardinalityEstimate... inputEstimates) {
            assert TestSniffOperator.this.getNumInputs() == inputEstimates.length;
